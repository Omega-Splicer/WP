...
//            this.DataContext = m_vm;
        ...
        private void SwichControlMode(object sender, RoutedEventArgs e)
        {
        }

        private void FlyPage(object sender, RoutedEventArgs e)
        {
            if (((ViewModel)this.DataContext).SelectedModule != null)
